  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
      <section class="space-y-6">
        ...
        <div v-else-if="!loading && !errorMsg" class="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <aside class="min-h-[420px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm xl:sticky xl:top-6 xl:h-[calc(100vh-8rem)]">
        <CandidateTimeline />
      </aside>
    </div>
  </div>
